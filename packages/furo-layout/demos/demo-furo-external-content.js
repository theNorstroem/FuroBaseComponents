...
class DemoFuroExternalContent extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-demo-snippet>
        <template>
          <furo-external-content src="https://www.openstreetmap.org/export/embed.html?bbox=-0.004017949104309083%2C51.47612752641776%2C0.00030577182769775396%2C51.478569861898606&layer=mapnik"></furo-external-content>
        </template>
      </furo-demo-snippet>
    `;
  }
